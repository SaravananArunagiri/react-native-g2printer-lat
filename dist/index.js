...
var GPrinter2 = NativeModules.GPrinter2;
var DIRECTION = {
    FORWARD: 0,
    BACKWARD: 1
};
...
export var G2Printer = {
    printTestPage: function (address) {
        return GPrinter2.printTestPage(address);
    },
    printLabel: function (options) {
        return GPrinter2.printLabel(options);
    },
    calibration: function (address) {
        return GPrinter2.calibration(address);
    },
    setCutOn: function (address) {
        return GPrinter2.setCutOn(address);
    },
    setCutOff: function (address) {
        return GPrinter2.setCutOff(address);
    },
    printReceipt: function (options) {
